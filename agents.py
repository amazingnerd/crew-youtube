...
class YoutubeAutomationAgents():
    def youtube_manager(self):
        return Agent(
            ...
            backstory="""As a methodical and detailed oriented managar, you are responsible for overseeing the preperation of YouTube videos.
                ...
                1. Search YouTube to find a minimum of 5 other videos on the same topic and analyze their titles and descriptions.
                2. Create a list of 10 potential titles that are less than 70 characters and should have a high click-through-rate.
                    -  Make sure you pass the list of 5 videos to the title creator 
    ...
    def research_manager(self, youtube_video_search_tool, youtube_video_details_tool):
        return Agent(
            ...
            goal="""For a given topic and description for a new YouTube video, find a minimum of 5 high-performing videos 
    ...
    def title_creator(self):
        return Agent(
            role="Title Creator",
            goal="""Create 5 potential titles for a given YouTube video topic and description. 
            ...
            backstory="""As a Title Creator, you are responsible for creating 5 potential titles for a given 
